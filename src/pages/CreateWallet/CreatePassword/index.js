...
const CreatePassword = withRouter(({ 
  ...
  const passwordChanged = e => {
    ...
    if (e.target.value.length > 7 
      && shouldInclude.test(e.target.value)) {
        ...
        >
          <Styled.Container>
            ...
            { !keyStoreFileDownloaded
              ? <>
                  <ContinueBtn
                    clicked={ () => downloadKeystoreFile() }
                    text="Download keystore file"
                    disabled={ !(pswd && agreedTerms) }
                  />
            ...
            <Styled.Disclaimer>
              ...
              />
              <p>
                I understand that DXpert cannot recover or reset my password or
                the keystore file. I will make a backup of the keystore
