...
const Success = withRouter(({ isShown, clickedContinue, history, logout }) => {
  const close = () => {
    logout();
    history.push("/");
  };
      ...
      {(state) => (
        ...
        >
          <Styled.Container>
            ...
            <Styled.Notification>
              You are ready to use the DXpert Wallet and Decentralized Exchange!
            </Styled.Notification>
            <Styled.UnlockWallet to="/unlock-wallet">
              <ContinueBtn clicked={clickedContinue} text="Unlock the wallet" />
            </Styled.UnlockWallet>
          </Styled.Container>
        </Styled.Paper>
      )}
