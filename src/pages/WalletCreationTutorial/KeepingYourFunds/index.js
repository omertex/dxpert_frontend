  ...
  >
    {(state) => (
      ...
      >
        ...
        <Styled.Text>
          You are solely responsible for keeping your funds. No one else, not
          even DXpert, can help you recover your wallet if you lose it.
        </Styled.Text>
        <Styled.Buttons>
          <Styled.SkipTutorial to="/create-wallet">
            Skip tutorial (Not recommended)
          </Styled.SkipTutorial>
          <ContinueBtn clicked={closeKeepingYourFunds} text="Next" />
        </Styled.Buttons>
      </Styled.Container>
    )}
  </Transition>
