...
export default ({ isShownOurCommitment, closeOurCommitment }) => (
  ...
  >
    { state => (
      ...
      <Styled.Text>Dxpert is committed to providing you with the best and safest experience. We ask for a minute of your time to understand how decentralized wallets work and to take action in safeguarding yourself.</Styled.Text>
      <Styled.Buttons>
        <Styled.SkipTutorial to="/create-wallet">Skip tutorial (Not recommended)</Styled.SkipTutorial>
        <ContinueBtn 
          clicked={ closeOurCommitment }
          text="Next"
        />
      </Styled.Buttons>
    </Styled.Container>
