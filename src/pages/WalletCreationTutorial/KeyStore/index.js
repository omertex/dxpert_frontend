...
export default ({ isShownKeyStore, closeKeyStore }) => (
  ...
  >
    { state => (
      ...
      <Styled.Text>You can think of the keystore file like a “User ID”, while the password unlocks your wallet. Both are needed to access your wallet, so keep them safe.</Styled.Text>
      <Styled.Buttons>
        <Styled.SkipTutorial to="/create-wallet">Skip tutorial (Not recommended)</Styled.SkipTutorial>
        <ContinueBtn 
          clicked={ closeKeyStore }
          text="Next"
        />
      </Styled.Buttons>
    </Styled.Container>
