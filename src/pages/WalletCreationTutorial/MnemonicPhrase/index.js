...
export default ({ isShownMnemonicPhrase, closeMnemonicPhrase }) => (
  ...
  >
    { state => (
      ...
      <Styled.Text>24 words that are both the “User ID” and password. This is a secondary way to access your wallet if you lose your keystore file or forgot your password. Anyone who knows your mnemonic phrase can access your wallet, so keep it safe</Styled.Text>
      <Styled.Buttons>
        <Styled.SkipTutorial to="/create-wallet">Skip tutorial (Not recommended)</Styled.SkipTutorial>
        <ContinueBtn 
          clicked={ closeMnemonicPhrase }
          text="Next"
        />
      </Styled.Buttons>
    </Styled.Container>
