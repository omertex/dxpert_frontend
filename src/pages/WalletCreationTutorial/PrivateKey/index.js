...
export default ({ isShownPrivateKey, closePrivateKey }) => (
  ...
  >
    { state => (
      ...
      <Styled.Text>This is an alternative representationof the mnemonic phase words. DXpert requires all users to use the keystore file + password; and choose betweenn the mnemonic phrase or private key as a secondary method</Styled.Text>
